		...
		return {
			...
			registerEditor: function(name, scope, targetToolbars){
				...
				editors[name] = {
					...
					editorFunctions: {
						hide: function(){
							angular.forEach(targetToolbars, function(targetToolbar){ $('div[name="' + targetToolbar + '"]').fadeOut(); });
						},
						show: function() {
							angular.forEach(targetToolbars, function(targetToolbar){ $('div[name="' + targetToolbar + '"]').fadeIn(); });
						},
						disable: function(){
